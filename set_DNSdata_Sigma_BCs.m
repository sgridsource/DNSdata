...
BeginCFunction[] := Module[{},
  ...
  pr["int RegularityOnAxis = Getv(\"DNSdata_Sigma_surface_BCs\",\"RegularityOnAxis\");\n"];
  pr["int SigmaZeroAtPoint = Getv(\"DNSdata_Sigma_surface_BCs\",\"ZeroAtPoint\");\n"];
  pr["int AtA0B0 = Getv(\"DNSdata_Sigma_surface_BCs\",\"AtA0B0\");\n"];
  pr["int AtA0B1 = Getv(\"DNSdata_Sigma_surface_BCs\",\"AtA0B1\");\n"];
