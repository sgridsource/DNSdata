(* DNS_set_J_ADM_VolInt_integrand.m 
...
CFunctionFile = "DNS_set_J_ADM_VolInt_integrand.c"
...
BeginCFunction[] := Module[{},
  ...
  pr["void DNS_set_J_ADM_VolInt_integrand(tGrid *grid, int iIntegx, int iIntegy, int iIntegz)\n"];
  pr["{\n"];
